...
static const char *headphones[] = {"/usr/bin/pactl", "set-sink-port", "alsa_output.pci-0000_00_1b.0.analog-stereo", "analog-output-headphones" };

static const char *speakers[] = {"/usr/bin/pactl", "set-sink-port", "alsa_output.pci-0000_00_1b.0.analog-stereo", "analog-output-speaker" };
...
static Key keys[] = {
	...
	{ Mod4Mask, 					XK_End,    spawn, 		   {.v = mutevol } },
	{ Mod4Mask, 					XK_Insert, spawn, 		   {.v = headphones } },
	{ Mod4Mask, 					XK_Home,   spawn,  		   {.v = speakers } },
